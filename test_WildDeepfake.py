...
class Model:
  ...
  def load(self, epoch, model_dir):
    ...
    if os.path.exists(filename):
      state = torch.load(filename)#When we do not use GPU
...
MODEL_DIR = '/shared/rc/defake/Deepfake-Slayer/models_binary/test_WildDeepfake/'
BACKBONE = 'xcp'
MAPTYPE = 'reg'#'tmp'
BATCH_SIZE = 200
MAX_EPOCHS = 100
...
RESDIR = '/shared/rc/defake/Deepfake-Slayer/models_binary/test_WildDeepfake/xcp_reg/'#'/shared/rc/defake/Deepfake-Slayer/models/test/xcp_reg'#/content/models/xcp_tmp/results_0.mat /content/models/test/xcp_reg
...
def main():
  ...
  with open('/shared/rc/defake/Deepfake-Slayer/WildDeepfake_pickel_file/fake_Wilddeepfake.pkl', 'rb') as file:#/shared/rc/defake/Deepfake-Slayer/pickel_file/real_yt_test.pkl
    fake = pickle.load(file)
  with open('/shared/rc/defake/Deepfake-Slayer/WildDeepfake_pickel_file/real_Wilddeepfake.pkl', 'rb') as file:#/shared/rc/defake/Deepfake-Slayer/pickel_file/real_actors_test.pkl
    real = pickle.load(file)

  test_list = fake['test'] + real['test']
  test_dataset = WildDeepfakeDataset(test_list, transform, transform_mask)
  batch_size = 128
  shuffle = True
  ...
  if not os.path.exists(output):
        os.makedirs(output)
  file = open(f'{output}/test_WildDeepfake.txt','w')
