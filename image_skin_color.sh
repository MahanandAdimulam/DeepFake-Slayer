...
#SBATCH --job-name=ImageSkinColorLabel		# Name for your job
#SBATCH --comment="Label for images on skin color"		# Comment for your job
...
#SBATCH --mem-per-cpu=180g		# Memory per CPU
...
python /shared/rc/defake/Deepfake-Slayer/scripts/DeepFake-Slayer/image_skin_color.py
deactivate
