...
#SBATCH --job-name=WildDeepfakePathCreation		# Name for your job
#SBATCH --comment="Creating path for WildDeepfakes"		# Comment for your job
...
python /shared/rc/defake/Deepfake-Slayer/scripts/DeepFake-Slayer/WildDeepfake_paths.py
deactivate
