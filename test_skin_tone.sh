...
#SBATCH --job-name=TestSkin		# Name for your job
#SBATCH --comment="Testing the FaceForensics++ with skin tone"		# Comment for your job
...
python /shared/rc/defake/Deepfake-Slayer/scripts/DeepFake-Slayer/test_skin_tone.py
deactivate
