...
MODEL_DIR = '/shared/rc/defake/Deepfake-Slayer/models_threshold1/train/'#/shared/rc/defake/Deepfake-Slayer/models/train
...
def iou_loss(predicted_mask, ground_truth_mask, smooth=1e-6):
    ...
    ground_truth_mask = (ground_truth_mask >= 0.1).float()
...
def get_uniform_frames(train_list,num_frames):
  ...
  #   selected_frames.extend(random.sample(frames,min(num_frames,len(frames))))
...
def main():
  ...
  output = '/shared/rc/defake/Deepfake-Slayer/output/train_threshold1'
  ...
  counter = 0
  best_epoch = 0
  model_dir = '/shared/rc/defake/Deepfake-Slayer/models_threshold1/FFDmodel/'
  best_dir = '/shared/rc/defake/Deepfake-Slayer/models_threshold1/FFDmodel/best'
  # model_dir = '/content/gdrive/MyDrive/shared/rc/defake/FaceForensics++_All/FaceForensics++/models/FFDmodel'
  if not os.path.exists(model_dir):
      os.makedirs(model_dir)
  if not os.path.exists(best_dir):
      os.makedirs(best_dir)
  writer = SummaryWriter(log_dir='/shared/rc/defake/Deepfake-Slayer/output/logs_threshold1')
