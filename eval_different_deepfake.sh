...
#SBATCH --job-name=EvalDifferentDeepfake		# Name for your job
#SBATCH --comment="Evaluation of different deepfake"		# Comment for your job
...
python /shared/rc/defake/Deepfake-Slayer/scripts/DeepFake-Slayer/eval_different_deepfake.py
deactivate
