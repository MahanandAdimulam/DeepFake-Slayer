...
#SBATCH --job-name=ForcedRedChannelTest		# Name for your job
#SBATCH --comment="Testing on forced red channel"		# Comment for your job
...
python /shared/rc/defake/Deepfake-Slayer/scripts/DeepFake-Slayer/test_rgb_green.py
deactivate
