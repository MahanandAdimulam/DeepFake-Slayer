...
#SBATCH --job-name=KMEANS		# Name for your job
#SBATCH --comment="Kmeans"		# Comment for your job
...
python /shared/rc/defake/Deepfake-Slayer/scripts/DeepFake-Slayer/kmeans_skin.py
deactivate
