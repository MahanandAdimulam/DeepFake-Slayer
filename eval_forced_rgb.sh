...
#SBATCH --job-name=ForcedRGBEvaluation		# Name for your job
#SBATCH --comment="Evaluation of the model on forced rgb values"		# Comment for your job
...
python /shared/rc/defake/Deepfake-Slayer/scripts/DeepFake-Slayer/eval_forced_rgb.py
deactivate
