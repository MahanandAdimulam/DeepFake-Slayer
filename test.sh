...
#SBATCH --job-name=FaceForensicsTest		# Name for your job
#SBATCH --comment="Testing the FaceForensics++"		# Comment for your job
...
#SBATCH --time=0-03:00:00		# Time limit
...
python /shared/rc/defake/Deepfake-Slayer/scripts/test.py
deactivate
